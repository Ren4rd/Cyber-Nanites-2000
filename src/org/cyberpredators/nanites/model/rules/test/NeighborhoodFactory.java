...
public class NeighborhoodFactory {
	...
	public static List<Byte> create(int... neighborsStates) {
		List<Byte> neighborhood = new ArrayList<>();
		for (int state : neighborsStates)
			neighborhood.add((byte) state);
		return neighborhood;
	}
}
